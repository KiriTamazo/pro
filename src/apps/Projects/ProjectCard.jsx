  ...
  return (
    <>
      <a
        target="_blank"
        href={url[0]}
        className="bg-slate-100 group shadow-sm hover:scale-105 transition-all duration-300 ease-linear cursor-pointer flex flex-col gap-4 dark:bg-indigo-500/20  h-fit xs:h-auto sm:max-w-[80%] md:max-w-screen-lg md:min-h-[14.5rem] p-3  lg:h-full md:p-2 rounded-md mx-auto "
      >
        <div className="flex flex-col xs:flex-row gap-2 h-full sm:gap-4">
          <img
            className="rounded-md flex-1 min-w-[10rem] w-full min-h-[10rem] object-fill"
            src={img}
            alt=""
          />
        ...
        <div className="flex flex-wrap justify-start gap-3 md:mb-0 ">
