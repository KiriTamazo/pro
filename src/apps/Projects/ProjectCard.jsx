...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div className="relative group  transition duration-500 ease-in-out  rounded-lg overflow-hidden">
      ...
      <div
        className="absolute  z-20 right-0 left-0 bottom-0  text-slate-900 translate-y-0 h-[55px] group-hover:-translate-y-60 xs:group-hover:-translate-y-48
      transition duration-500 ease-in-out   "
      >
        <p className="bg-indigo-500 text-white text-xl font-semibold py-2 px-2 ">
          {title}
        </p>
        <div className="bg-slate-900/90 flex items-center justify-center sm:justify-start flex-col gap-4 group-hover:min-h-[350px] xs:group-hover:min-h-[300px]  text-white pt-4 pb-8 px-2 sm:px-4">
          <p>{desc}</p>
