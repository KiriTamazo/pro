    ...
    <div className="container h-auto pt-24">
      <section id="abilities" className="pt-10 pb-24">
        ...
        <motion.div
          ...
          className="grid grid-cols-2  sm:grid-cols-3 justify-center md:grid-cols-5  xl:grid:cols-9 gap-4 mt-16 bg-indigo-500/20 rounded w-full h-full py-6 max-w-[1200px] mx-auto"
        >
